...
from main import count_words, calculate, search_text

async def test_concurrency():
    print("Starting concurrency test for main.py...")
    ...
    # Note: We use .fn to access the underlying function of the FastMCP tool
    tasks = [
